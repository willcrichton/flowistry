...
sourcesIndex["flowistry"] = {"name":"","dirs":[{"name":"indexed","files":["impls.rs","mod.rs"]},{"name":"infoflow","files":["analysis.rs","dependencies.rs","mod.rs"]},{"name":"mir","files":["aliases.rs","borrowck_facts.rs","control_dependencies.rs","engine.rs","mod.rs","utils.rs"]}],"files":["extensions.rs","lib.rs","source_map.rs","test_utils.rs","timer.rs"]};
sourcesIndex["flowistry_ide"] = {"name":"","dirs":[{"name":"effects","files":["mod.rs","visitor.rs"]}],"files":["analysis.rs","graph.rs","hir.rs","lib.rs","range.rs","slicing.rs"]};
...
sourcesIndex["html_escape"] = {"name":"","dirs":[{"name":"decode","dirs":[{"name":"element","files":["decode_impl.rs","mod.rs","script.rs","style.rs"]},{"name":"html_entity","files":["mod.rs","tables.rs"]}],"files":["mod.rs"]},{"name":"encode","dirs":[{"name":"element","files":["encode_impl.rs","mod.rs","script.rs","style.rs"]},{"name":"html_entity","files":["mod.rs","unquoted_attribute.rs"]}],"files":["mod.rs"]}],"files":["functions.rs","lib.rs"]};
...
sourcesIndex["utf8_width"] = {"name":"","files":["lib.rs"]};
createSourceSidebar();
