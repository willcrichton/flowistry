...
/// Set this to false if you need to use the `Point` indexes
/// generated by Polonius.
pub static NO_SIMPLIFY: AtomicBool = AtomicBool::new(false);
...
fn mir_borrowck<'tcx>(tcx: TyCtxt<'tcx>, def_id: LocalDefId) -> mir_borrowck<'tcx> {
  ...
  if !NO_SIMPLIFY.load(Ordering::SeqCst) {
